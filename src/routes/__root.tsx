...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <Outlet />
      <Toaster position="bottom-center" richColors closeButton className="mb-20 lg:mb-4" />
    </QueryClientProvider>
  );
}
