      ...
      <Collapsible open={open} onOpenChange={onOpenChange} defaultOpen={defaultOpen}>
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          <CollapsibleTrigger className="group flex min-w-0 flex-1 items-start gap-2 rounded-lg text-left outline-none focus-visible:ring-2 focus-visible:ring-ring">
            <ChevronDown className="mt-1 size-4 shrink-0 text-muted-foreground transition-transform duration-200 group-data-[state=closed]:-rotate-90 motion-reduce:transition-none" />
        ...
        <CollapsibleContent className="collapsible-grid grid grid-rows-[0fr] data-[state=closed]:grid-rows-[0fr] data-[state=open]:grid-rows-[1fr] motion-reduce:transition-none">
