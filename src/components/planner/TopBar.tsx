...
export function TopBar({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/50 bg-panel/90 backdrop-blur-xl no-print shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
        ...
        <div className="relative min-w-0 flex-1 sm:max-w-md" ref={listRef}>
          ...
          {showDropdown && hasResults && (
            <ul
              ...
              role="listbox"
              className="absolute left-0 right-0 top-full z-50 mt-1 max-h-64 overflow-auto rounded-xl border border-border bg-popover p-1 shadow-[var(--shadow-pop)] animate-in fade-in slide-in-from-top-1 duration-200"
            >
          ...
          {showDropdown && searchResults && searchResults.length === 0 && (
            <div
              className="absolute left-0 right-0 top-full z-50 mt-1 rounded-xl border border-border bg-popover p-3 text-sm text-muted-foreground shadow-[var(--shadow-pop)]"
              role="status"
            >
